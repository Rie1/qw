...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Es303hBXgbN9gMaEmSg5.31vnr4tehCwsRM/Q+Chwrq.T/95Je3g9vi6iAUXPqUmbUvIL/rtjsfnxZ+Iz3NCSGI=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EsSEVewvKg8jg39PFYy2.8jf/1y29svg5xudrJ2TrmG.ctctx+Y6WgYrJPgsftU6xKpcZV/dSGsDvYXf8xSZlq4=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Es7VJtsrQGulbLCOuYfc.jYGmclqC4KdaHHM7QJtdha.6AdSMC8oRnwi9fds/5MIcK56jQhz+zmdmQ2RTs7Lm9U=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EsRdlOxdMpB8bUStQFne.a+e+tJt+MwPE6rwd7jM5dG.qfirWwvYXH4lbqUfBzoT+4SH5hnKMXtFqkmD6uNbQ5c=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EsnQPtL8wnFeLek2mYL3.qrh+F6D8ve3vaA2o6z4viW.aByacocHFTE6LXn+RTj5nWe5qs20rhkv0+8nJb82WHg=')
kr.loginResult()
print "Kr-Login Success\n"

vipro = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
#vipro.login(qr=True)
vipro.login(token='Es4edvW4YP11gB4PgAme.ccys8tuFvu++SAeG8YQBdG.BPQKMZWmUiHSAK8yYqw9uBY//RZZfKNaj6jNEJsFJ0c=')
vipro.loginResult()
print "Vipro-Login Success\n"

km = LINETCR.LINE() #(bot ini di luar grup fungsinya jadi algojo kaya kicker siri)
#km.login(qr=True)
km.login(token='ErH0b3vw0leER10iYMYe.a+e+tJt+MwPE6rwd7jM5dG.kB51wIuyXfaXAgpjZwXAW3E7dwha7McOkSUnO+qG8To=')
km.loginResult()
...
╚═════════════════════════
"""
vip="u082612f1351f554fffb1a120f32a9b0e"
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u082612f1351f554fffb1a120f32a9b0e"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : Quesoo\nContact Me : 👉 line.me/ti/p/~akbarr288",
    "comment2":"Auto Like ©By : Queso\nContact Me : 👉 line.me/ti/p/~akbarr288",
    "comment3":"Auto Like ©By : Queso\nContact Me : 👉 line.me/ti/p/~akbarr288",
    "comment4":"Auto Like ©By : Queso\nContact Me : 👉 line.me/ti/p/~akbarr288",
    "comment5":"Auto Like ©By : Queso\nContact Me : 👉 line.me/ti/p/~akbarr288",    
    "commentOn":True,
    "commentBlack":{},
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Owner Saya (^_^)")
                ...
                msg.contentType = 13
                admin1 = "u082612f1351f554fffb1a120f32a9b0e"
...
#		else:                    
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "u082612f1351f554fffb1a120f32a9b0e"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
